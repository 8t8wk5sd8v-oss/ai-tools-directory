      ...
      <div className="relative overflow-hidden border-b border-slate-800/60">
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-16 pb-14">
          ...
          <div className="flex flex-col sm:flex-row gap-3 max-w-xl">
            ...
            <a
              href="#recommender"
              className="inline-flex items-center justify-center gap-2 px-5 py-3.5 rounded-xl border border-indigo-500/50 bg-indigo-500/10 text-indigo-300 hover:bg-indigo-500/20 hover:text-indigo-200 text-sm font-medium transition whitespace-nowrap"
            >
